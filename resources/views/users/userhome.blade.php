                ...
                <div class="carousel-item position-relative active" style="min-height: 100vh;">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h6 class="text-white text-uppercase mb-3 animate_animated animate_fadeInDown"
                                style="letter-spacing: 3px;">Spa & Beauty Center</h6>
                            <h3 class="display-3 text-capitalize text-white mb-3">Massage Treatment</h3>
                            <p class="mx-md-5 px-5">We provide a trained, certified medical professional (massage
                                therapist)
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="card">
                                                            <img class="img-fluid" alt="100%x280"
                                                                src="{{ URL::asset('uploads/' . $service['images'][0]->image_name) }}">
                                                            <div class="card-body">
                                ...
                                @foreach ($products as $product)
                                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0 shadow-sm p-3 mb-5 bg-white rounded"
                                        ...
                                        <div class="icon-box"><a href={{ url('/singleproduct/' . $product->id) }}>
                                                ...
                                                <a class="btn btn-primary"
                                                    href={{ url('/singleproduct/' . $product->id) }}>View Details</a>
                                        </div>
                                        </a>
                ...
                <div class="container py-5">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            <p class="pl-4 border-left border-primary">At Spa Center, we have been on a mission to make
                                selfcare a priority rather than a treat
                                since 2021, when we first opened our doors at the quaint spa in the idyllic Himalayan hills
                                of Manali.

                                We believe that in the hustle and bustle of urban life, a few moments of self care, woven
                                into your daily regimen,
                                have the potential to help you unwind and reconnect with yourself. Bring the Spa like
                                serenity & tranquility in your daily lives.</p>
                            <div class="row pt-3">
                                <div class="col-6">
                    ...
                    <div class="col-lg-6 pt-5 pb-lg-5">
                        <div class="hours-text bg-light p-4 p-lg-5 my-lg-5">
                            ...
                            <p>We Provide our best services as much as we can to the people who love their healthy body.
                                And we are happy to serve you guys with full hearty pleasure. welcome to our Spa Center...
                            </p>
                            ...
                            <a href="/booking" class="btn btn-primary mt-2">Book Now</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container py-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6" style="min-height: 500px;">
                            <div class="position-relative h-100">
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d62865.5581909634!2d76.31566121157238!3d10.008814168278752!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b080d514abec6bf%3A0xbd582caa5844192!2sKochi%2C%20Kerala!5e0!3m2!1sen!2sin!4v1641577368100!5m2!1sen!2sin"
