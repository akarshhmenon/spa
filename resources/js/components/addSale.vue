...
<a
    type="button"
        class="close"
@click="clearNewCustomer()"
      >
        <span aria-hidden="true" class="modal-title-custom text-danger">&times;</span>
      </a>
</div>
...
<label class="">Enter GST Number</label>
        ...
        <div class="row" v-if="vehiclecheck">
          <div class="col">
            <div class="form-group">
...
if(this.newCustomer == true && ( this.sale.name == '' || this.sale.mobile =='')){
if(this.sale.name == ''){
