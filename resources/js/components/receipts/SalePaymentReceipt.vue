<template>
  <div>
    <div class="page-content container" >
      <div class="container px-2" id="print-area">
        <div class="row">
          <div class="col">
        ...
        <div class="row" v-if="billDetails.length != 0">
          <div class="col-12 col-lg-12">
              ...
              <div class="col-sm-6">
                ...
                <div class="text-grey-m2">
                  ...
                  <div class="my-1">
                    ...
                    ></i>
                    <b class="text-600">{{ billDetails[0].mobile }}</b>
                  </div>
                </div>
              </div>
              <!-- /.col -->
            ...
            <div class="mt-4">
              <div class="row text-600 text-white bgc-default-tp1 py-25">
                ...
                <div class="col-9 col-sm-3">Product</div>
                <div class="d-none d-sm-block col-4 col-sm-1">Qty</div>
                <div class="d-none d-sm-block col-sm-1">Rate</div>
                 <div class="d-none d-sm-block col-sm-2">Total Rate</div>
                 <div class="d-none d-sm-block col-sm-2">Taxable Amount</div>
              ...
              <div class="text-95 text-secondary-d3">
                ...
                >
                  ...
                  <div class="col-9 col-sm-3">{{ item.product_name }}</div>
                  <div class="d-none d-sm-block col-1">{{ item.quantity }}</div>
                  <div class="d-none d-sm-block col-1 text-95">
                    {{ parseFloat(item.rate ).toFixed(2) }}
                  </div>
                  <div class="d-none d-sm-block col-2 text-95">
                    {{ parseFloat(item.total_rate).toFixed(2)  }}
                  </div><div class="d-none d-sm-block col-2 text-95">
                  ...
                  <div class="row my-2">
                    ...
                    <div class="col-5">
                      <span class="text-120 text-secondary-d1"
                        >{{ parseFloat(net_total_amount).toFixed(2) }}.</span
                      >
                    </div>
                  </div>
                  ...
                  <div class="row my-2">
                    ...
                    <div class="col-5">
                      <span class="text-110 text-secondary-d1"
                        >{{
                          parseFloat(billDetails[0].discount).toFixed(2)
                        }}.</span
                      >
                    </div>
                  </div>
                  ...
                  <div class="row my-2 align-items-center bgc-primary-l3 p-2">
                    ...
                    <div class="col-5">
                      <span class="text-150 text-success-d3 opacity-2"
                        >{{
                          parseFloat(
                            net_total_amount - billDetails[0].discount
                          ).toFixed(2)
                        }}/-</span
                      >
                    </div>
