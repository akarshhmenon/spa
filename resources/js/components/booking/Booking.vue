          ...
          <div class="col-lg-6 py-5">
            <div class="p-5 my-5" style="background: rgba(33, 30, 28, 0.7)">
              ...
              <div class="form-row">
                ...
                <div class="col-sm-6">
                  <div class="form-group datepickerColor">
              
                    <datepicker
                      :input-class="
                        date == ''
                          ? 'field-null form-control bg-transparent p-4'
                          : 'field-not-null form-control bg-transparent p-4'
                      "
                      v-model="date"
                      name="date"
                      :format="customFormat"
              ...
              <div class="form-row">
                ...
                <div class="col" align="center">
                  <input
                    ...
                    autocomplete="off"
                  />
                  <label class="btn btn-outline-primary" for="17"
                    >17:00pm</label
                  >
                </div>
              </div>
